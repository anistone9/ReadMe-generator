    ...
    return inquirer
        .prompt([
            ...
            },
            {
                ...
                name: 'license',
                choices: ['Apache licence 2.0', 'Boost Software License 1.0', 'Creative Commons Atribution 4.0', 'Educational Community License v2.0', 'GNU General Public License v3.0', 'Microsoft Public License', 'MIT', 'Mozilla Public License 2.0'],
                default: ['MIT'],
            },
            {
                type: 'input',
